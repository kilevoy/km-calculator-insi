...
- 108 тестов проверяют расчёты, границы и начальное состояние.
...
| Надёжность расчётов | 9/10 | 75 независимых Excel-сценариев и 108 тестов; нет полного комбинаторного перебора |
