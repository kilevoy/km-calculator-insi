...
- 128 тестов проверяют расчёты, внешние данные, границы, начальное состояние, модели КМ/АС, состав КП и security-контракт прокси.
...
- Проверить опубликованный GitHub Pages после production deploy.
...
| Надёжность расчётов | 9/10 | 75 независимых Excel-сценариев и 128 тестов; нет полного комбинаторного перебора |
