...
- 124 теста проверяют расчёты, внешние данные, границы, начальное состояние, модель АС, состав КП и security-контракт прокси.
...
| Надёжность расчётов | 9/10 | 75 независимых Excel-сценариев и 124 теста; нет полного комбинаторного перебора |
