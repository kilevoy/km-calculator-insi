...
- 118 тестов проверяют расчёты, внешние данные, границы, начальное состояние, состав КП и security-контракт прокси.
...
| Надёжность расчётов | 9/10 | 75 независимых Excel-сценариев и 118 тестов; нет полного комбинаторного перебора |
