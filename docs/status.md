...
- 115 тестов проверяют расчёты, внешние данные, границы, начальное состояние и security-контракт прокси.
...
- Добавить Git remote и выполнить push.
...
| Надёжность расчётов | 9/10 | 75 независимых Excel-сценариев и 115 тестов; нет полного комбинаторного перебора |
