...
- `src/components/CalculatorForm.tsx` — все пользовательские поля Excel.
...
Калькулятор, PDF, черновики, URL, тесты, CI и статическая сборка готовы. Для полного ввода в корпоративную эксплуатацию остаются внешние операции: выдать OAuth/service credentials Google Workspace, назначить целевую папку, развернуть прокси за HTTPS и выполнить приёмочный тест загрузки в реальный Drive.
